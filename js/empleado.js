'use strict'
 ...
 document.getElementById("btn_agregar").addEventListener('click',addEmpleado);
 document.getElementById("btn_eliminar").addEventListener('click',deleteEmpleado);
 ...
 function addEmpleado()
 {
    ...
    lista_de_Empleados.innerHTML=" cachin";
    let Nro_empleado=document.getElementById('idEmpleado').value;
